...
def read_org_dataset(file_path, prompt_id ,tokenize_text, to_lower ):
    data = []
    with open(file_path, mode='r', encoding='UTF8') as input_file:
        lines = [i.replace('\n','') for i in input_file.readlines()][1:]
        for line in lines:
...
def read_org_sen(file_path, prompt_id ,tokenize_text, to_lower ):
    data = []
    with open(file_path, mode='r', encoding='UTF8') as input_file:
        lines = [i.replace('\n','') for i in input_file.readlines()][1:]
        for line in lines:
...
def read_org(file_path, prompt_id ,tokenize_text, to_lower ):
    data = []
    with open(file_path, mode='r', encoding='UTF8') as input_file:
        lines = [i.replace('\n','') for i in input_file.readlines()][1:]
        for line in lines:
